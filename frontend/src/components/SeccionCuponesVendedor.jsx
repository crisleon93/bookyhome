...
// ── Tarjeta de cupón ──
function TarjetaCupon({ coupon, onEditar, onEliminar, onToggle }) {
    ...
    >
      ...
      <div style={{ padding: "18px 18px 14px" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "10px", marginBottom: "14px" }}>
          <div style={{ minWidth: 0 }}>
            <div style={{
              ...
              <IconTag width={13} height={13} strokeWidth={2} style={{ color: "#c4c9d4" }} />
              Código promocional
            </div>
            <div style={{
              display: "inline-flex", alignItems: "center", gap: "8px",
              padding: "7px 14px", borderRadius: "10px",
              background: "#fafafa", border: `1.5px dashed ${cfg.stripe}`,
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px", marginBottom: "14px" }}>
          ...
          {coupon.usos_maximos && (
            <span style={{ fontSize: "0.72rem", fontWeight: 700, color: agotado ? "#dc2626" : "#6b7280" }}>
        ...
        {coupon.usos_maximos ? (
          ...
          <div style={{ marginBottom: "14px", fontSize: "0.78rem", color: "#6b7280", display: "flex", alignItems: "center", gap: "6px" }}>
            <span>{usosActuales} usos realizados</span>
        ...
        {/* Detalles */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", borderTop: "1px solid #f3f4f6", paddingTop: "12px", marginBottom: "12px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "7px", fontSize: "0.8rem", color: "#4b5563" }}>
            <IconDollar width={13} height={13} strokeWidth={2} style={{ color: "#c4c9d4", flexShrink: 0 }} />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "7px", fontSize: "0.8rem", color: "#4b5563" }}>
            <IconCalendar width={13} height={13} strokeWidth={2} style={{ color: "#c4c9d4", flexShrink: 0 }} />
            <span style={{ lineHeight: 1.3 }}>
              Vigencia
              <div style={{ fontWeight: 800, color: "#1f2937" }}>
        ...
        <div style={{ display: "flex", gap: "8px", borderTop: "1px solid #f3f4f6", paddingTop: "12px" }}>
          <button
            ...
            style={{
              ...
              padding: "8px 0", borderRadius: "9px", background: "#f3f4f6",
              border: "1px solid #e5e7eb", color: "#374151", fontWeight: 700,
          ...
          <button
            ...
            style={{
              flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: "5px",
              padding: "8px 0", borderRadius: "9px", background: "#fef2f2",
              border: "1px solid #fecaca", color: "#dc2626", fontWeight: 700,
              fontSize: "0.8rem", cursor: "pointer", fontFamily: "inherit", transition: "background 0.15s"
            }}
...
export default function SeccionCuponesVendedor({ tiendaId }) {
  ...
  const onFocusInput = (e) => {
    e.currentTarget.style.borderColor = "#7A1E3A";
    e.currentTarget.style.boxShadow = "0 0 0 3px rgba(122,30,58,0.1)";
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: "12px", alignItems: "center", flexWrap: "wrap" }}>
          {[
            ...
            { label: "Usos", value: totalUsos, color: "#3b82f6", bg: "#dbeafe" },
            { label: "Total", value: coupons.length, color: "#7A1E3A", bg: "#fbe8ee" },
          ].map((s) => (
        ...
        {!loading && coupons.length === 0 && (
          <div style={{ border: "2px dashed #e5e7eb", borderRadius: "14px", padding: "56px 20px", textAlign: "center" }}>
            <div style={{
              ...
              <IconGift width={30} height={30} strokeWidth={1.8} style={{ color: "#C5425A" }} />
            </div>
            <h3 style={{ margin: "0 0 8px", color: "#1f2937", fontSize: "1.05rem" }}>Sin cupones todavía</h3>
            ...
            >
              ...
              <div style={{ flex: "1 1 380px", minWidth: 0 }}>
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            boxShadow: seleccionado ? "0 3px 12px rgba(122,30,58,0.1)" : "none",
                        ...
                        >
                          <div style={{
                            ...
                            background: seleccionado ? "#7A1E3A" : "#f3f4f6",
                            color: seleccionado ? "white" : "#6b7280",
                            display: "flex", alignItems: "center", justifyContent: "center",
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            <div style={{ fontWeight: 800, fontSize: "0.88rem", color: seleccionado ? "#7A1E3A" : "#1f2937" }}>
                              {t.label}
                            </div>
                            <div style={{ fontSize: "0.72rem", color: "#6b7280" }}>{t.desc}</div>
                          </div>
                        </div>
                      );
                    })}
                ...
                <div style={{
                  ...
                  border: "1.5px solid #e5e7eb", padding: "16px", marginBottom: "18px"
                }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "7px", marginBottom: "12px" }}>
                    <IconCalendar width={15} height={15} strokeWidth={2.2} style={{ color: "#7A1E3A" }} />
              ...
              <div style={{ flex: "0 1 300px", minWidth: "250px" }}>
                <div style={{
                  ...
                  background: "#f8f6f4", borderRadius: "14px",
                  border: "1.5px solid #e5e7eb", padding: "18px"
                }}>
                  <div style={{
                    display: "flex", alignItems: "center", gap: "6px",
                    fontSize: "0.72rem", fontWeight: 800, color: "#6b7280",
                    textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "14px"
                  }}>
                    <IconEye width={14} height={14} strokeWidth={2} style={{ color: "#9ca3af" }} />
                    Vista previa
                  </div>
                  ...
                  <div style={{
                    ...
                    <div style={{ padding: "22px 20px 16px", display: "flex", alignItems: "center", gap: "16px" }}>
                      ...
                      <div style={{ minWidth: 0, flex: 1 }}>
                        ...
                        <div style={{
                          ...
                          border: "1.5px dashed #7A1E3A", background: "#fdf7f8",
                          fontFamily: "'Courier New', monospace",
                          fontSize: "1.05rem", fontWeight: 800, letterSpacing: "2px", color: "#1f2937",
                          overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
                          maxWidth: "100%"
                        }}>
                    ...
                    <div style={{ position: "relative", height: "0", borderTop: "1.5px dashed #e5e7eb", margin: "0 8px" }}>
                      <div style={{
                    ...
                    <div style={{ padding: "16px 20px 18px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                      <div>
                        <div style={{ fontSize: "0.64rem", fontWeight: 800, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: "3px" }}>
                          Compra mínima
                        </div>
                        <div style={{ fontWeight: 800, fontSize: "0.86rem", color: "#1f2937" }}>

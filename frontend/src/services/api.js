...
export const checkoutDirecto = (payload = {}) => api.post('/carrito/checkout-directo', payload)
...
export const cancelOrder = (orderId, motivo) => api.delete(`/api/v1/orders/${orderId}`, { data: { motivo } })
export const cancelarMisPendientes = () => api.post('/api/v1/orders/cancelar-mis-pendientes')

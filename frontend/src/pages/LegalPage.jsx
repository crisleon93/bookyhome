...
function LegalPage({ type = 'all' }) {
  const showPrivacidad = type === 'all' || type === 'privacidad';
  const showTerminos = type === 'all' || type === 'terminos';
  ...
  return (
    <main className="layout-container" style={{ padding: '40px 20px', minHeight: '80vh' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        {showPrivacidad && (
          <section style={{ marginBottom: showTerminos ? '50px' : '0', background: '#fff', padding: '30px', borderRadius: '12px', border: '1.5px solid #e5e0d8', boxShadow: '0 4px 15px rgba(0,0,0,0.02)' }}>

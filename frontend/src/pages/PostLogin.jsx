...
export default function PostLogin() {
  ...
  useEffect(() => {
    if (activeSide === "Mis Compras" || activeSide === "Seguimiento" || activeSide === "Configuración") {
  ...
  const cargarDatosPerfil = useCallback(async () => {
    try {
      // Cargar estadísticas completas del nuevo endpoint
      try {
  ...
  // Helper functions para calcular nivel siguiente
  ...
  // Helper function para obtener colores según nivel
  ...
  // Helper function para calcular progreso hacia el siguiente nivel
  ...
  }, [paymentSuccess, activeSide, cargarDatosPerfil]);
  useEffect(() => {
  ...
  return (
    <div className="dashboard-container">
      ...
      <button
        ...
        onClick={() => handleSelectSection("Seguimiento")}
        aria-label="Abrir seguimiento de pedidos"
      >
      ...
      <main className="dashboard-main">
        ...
        {activeSide === "Seguimiento" && (
          <>
            ...
            {ordenesLoading ? (
            ...
            ) : ordenes.filter((orden) => orden.envio && orden.estado === "pagado").length === 0 ? (
              <div className="empty-state">
              ...
              <div style={{ display: "grid", gap: "14px" }}>
                {ordenes.filter((orden) => orden.envio && orden.estado === "pagado").map((orden) => (
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "500px" }}>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                    <div>
                      ...
                      <input type="text" value={userName} onChange={(e) => setUserName(e.target.value)} style={{ width: "100%", padding: "10px 14px", borderRadius: "8px", border: "1px solid #ddd", fontSize: "0.95rem" }} />
                    </div>
                    <div>
                      <label style={{ fontWeight: 600, color: "#444", display: "block", marginBottom: "6px" }}>Apellidos</label>
                      <input type="text" value={userSurname} onChange={(e) => setUserSurname(e.target.value)} style={{ width: "100%", padding: "10px 14px", borderRadius: "8px", border: "1px solid #ddd", fontSize: "0.95rem" }} />
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="tel" value={userPhone} onChange={(e) => setUserPhone(e.target.value)} style={{ width: "100%", padding: "10px 14px", borderRadius: "8px", border: "1px solid #ddd", fontSize: "0.95rem" }} />
                  </div>
                  <button onClick={handleActualizarPerfil} style={{ background: "var(--vinotinto)", color: "white", border: "none", padding: "12px 24px", borderRadius: "8px", fontWeight: 700, fontSize: "0.95rem", cursor: "pointer", marginTop: "8px" }}>
                    Guardar cambios
                  </button>
                </div>
              </div>

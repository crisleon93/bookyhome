  ...
  return (
    <div className="dashboard-container">
      ...
      <main className="dashboard-main">
        ...
        {/* ── OTRAS SECCIONES ── */}
        {!["Inicio", "Catálogo", "Carrito", "Mis Compras", "Seguimiento", "Lista de Deseos", "Favoritos", "Mi Perfil", "Mis Direcciones", "Configuración", "Notificaciones", "Mensajes"].includes(activeSide) && (
          <div className="welcome-card">
            <h1>{activeSide}</h1>

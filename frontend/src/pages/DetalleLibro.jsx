  ...
  const cargarLibro = async () => {
    try {
      ...
      const existe = favoritos.some(
        (f) => f.id_libro === response.data.id_libro
      );
    ...
    <main className="detalle-container">
      ...
      <div className="detalle-card">
        ...
        <div className="detalle-imagen">
          <img
            src={obtenerImagen(libro.nombre_categoria)}
            alt={libro.titulo}
          />
        </div>
        ...
        <div className="detalle-info">
          ...
          <p className="detalle-dato">
            <strong>Autor:</strong> {libro.autor_libro}
          </p>

          <p className="detalle-dato">
            <strong>Tienda:</strong> {libro.nombre_tienda}
          </p>
      ...
      <section className="detalle-descripcion">
        ...
        <p>
          ...
          Encuentra libros de distintas categorías,
          autores y librerías registradas en la
          plataforma.
        </p>
